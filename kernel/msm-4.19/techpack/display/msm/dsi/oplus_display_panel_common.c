...
bool is_soda_panel(void)
{
	...
	if (!strcmp(display->panel->name, "ili9881h 90hz boe fhd video mode dsi panel")
		|| !strcmp(display->panel->name, "ili9881h 90hz hlt fhd video mode dsi panel")
		|| !strcmp(display->panel->name, "ili9881h boe fhd video mode dsi panel")
		|| !strcmp(display->panel->name, "ili9882n 90hz boe fhd video mode dsi panel")
		|| !strcmp(display->panel->name, "ili9882n 90hz inx fhd video mode dsi panel")
		|| !strcmp(display->panel->name, "ili9882n 90hz txd fhd video mode dsi panel")
		|| !strcmp(display->panel->name, "nt36525b 90hz inx fhd video mode dsi panel")
		|| !strcmp(display->panel->name, "nt36525b inx fhd video mode dsi panel")) {
		return true;
	} else {
		return false;
	}
