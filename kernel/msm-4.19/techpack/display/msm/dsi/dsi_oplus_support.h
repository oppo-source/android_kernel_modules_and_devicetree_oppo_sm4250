...
******************************************************************/
#ifndef _DSI_OPLUS_SUPPORT_H_
#define _DSI_OPLUS_SUPPORT_H_
...
enum oplus_display_support_list {
	...
	OPLUS_SAMSUNG_SOFEF03F_M_DISPLAY_FHD_DSC_CMD_PANEL,
